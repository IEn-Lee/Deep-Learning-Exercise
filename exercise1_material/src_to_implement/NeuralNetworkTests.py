import unittest
from Layers import FullyConnected, Loss, ReLU, SoftMax, Base, Helpers
...
class TestFullyConnected1(unittest.TestCase):
    def setUp(self):
        ...
        for i in range(self.batch_size):
            self.label_tensor[i, np.random.randint(0, self.categories)] = (
    ...
    def test_trainable(self):
        ...
        self.assertTrue(
            layer.trainable,
            msg="Possible error: The  trainable flag is not set to True. Please make sure"
